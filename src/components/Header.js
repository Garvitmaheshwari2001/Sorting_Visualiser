  ...
  return (
    <div className="header">
      <div id="header__bar" style = {{transform: showHeaderBar? `translateY(120px)`: `translateY(0px)`}}>
        ...
        <a href="https://www.linkedin.com/in/garvitmaheshwari58/" target='_blank' rel="noreferrer"><img src="https://img.icons8.com/ios/50/000000/linkedin.png" /></a>
        <a href="https://github.com/Garvitmaheshwari2001" target='_blank' rel="noreferrer"><img src="https://img.icons8.com/ios/50/000000/github--v1.png"/></a>
        </div>
      </div>
